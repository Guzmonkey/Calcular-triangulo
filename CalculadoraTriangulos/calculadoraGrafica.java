    ...
    public void calculadoraTrianguloGrafico(){
        ...
        boton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                }else if(contador > 3 && ladoA < 0 && ladoB < 0 && ladoC < 0 && anguloA < 0 && anguloB < 0 && anguloC < 0){
                    JOptionPane.showMessageDialog(null, "No puedes ingresar más de 3 datos!", "Error", JOptionPane.WARNING_MESSAGE);
                }else if (contador < 3 && ladoA < 0 && ladoB < 0 && ladoC < 0 && anguloA < 0 && anguloB < 0 && anguloC < 0){ // Si el contador es menor a 3 mostramos un mensaje de error
